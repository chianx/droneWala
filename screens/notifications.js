...
export default function Notifications({navigation}) {
  ...
  return (
        ...
        {notifications.length === 0? <View style={{backgroundColor:'#f0f0f0', justifyContent:'center', height:'100%'}}><Text style={{fontSize:20, fontWeight:400, textAlign:'center'}}>No Notifications available at the moment.</Text></View> :<></>}
            <FlatList 
              data={notifications}
              refreshControl={
