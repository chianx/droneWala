        ...
        <View style={styles.container}>
            ...
            <View style={[styles.status]}>
                <View style={{ flexDirection: 'row', paddingBottom: 15 }}>
                    <View style={[styles.tab, active === 'Pending' && styles.btnActive, { borderBottomStartRadius: 30, borderTopLeftRadius: 30}]}>
                        <TouchableOpacity onPress={() => (setActive('Pending') & setDataList(pending))} ><Text style={[active === 'Pending' && { color: 'white' }]}>Jobs</Text></TouchableOpacity>
                    </View>
                    <View style={[styles.tab, active === 'Completed' && styles.btnActive, { borderBottomEndRadius: 30, borderTopRightRadius: 30}]}>
                        <TouchableOpacity onPress={() => setActive('Completed') & setDataList(completed)} ><Text style={[active === 'Completed' && { color: 'white' }]}>Freelance Projects</Text></TouchableOpacity>
                    </View>
                </View>
